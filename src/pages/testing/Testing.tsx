...
import ContactUsDetail from "../contactus/ContactUsDetails";
        ...
        >
          ...
          <Routes>
            ...
            <Route element={<ProtectedRoute />}>
              ...
              <Route
                path="/fareestimate/view/:id"
                element={<EditFareEstimate />}
              />
              ...
              <Route path="/contact-us/:id" element={<ContactUsDetail />} />
            </Route>
          </Routes>
        </BrowserRouter>
      </AuthProvider>
